...
/*
	...
	let it be known that, if your engineers manual throws an error
	for something not native to immersive engineering, it will not
	tell you what that error is. it will just tell you it errored.
...
*/
	...
	add_ore_vein(
		...
		"minecraft:the_nether",
		[
			["minecraft:glowstone_dust",0.13],
			["minecraft:netherrack",0.75],
			["minecraft:ancient_debris",0.07]
		]
	);
	add_ore_vein(
		"scorchia",
	...
	add_ore_vein(
		...
		"minecraft:the_nether",
		[
			["kubejs:nethered_silver",0.5],
			["kubejs:nethered_lead",0.5]
		]
	);
	add_ore_vein(
		"vanillite",
	...
	(["sculk","gloom"]).forEach(vt => {
		...
		add_ore_vein(
			...
			[
				[`kubejs:${ore_type}_lead`,0.5],
				[`kubejs:${ore_type}_uranium`,0.5],
			]
		);
		add_ore_vein(
			`${vt}_fluorium`,
